# SpeakNerd Weekly #61: GitHub

**Subject line:** Where all the world's code lives (seriously)

---

Hey — Steve here.

Last week we covered **Encryption**. This week, let's talk about something you've probably heard but maybe never fully understood.

## This Week's Term: GitHub

**The quick version:** Social media for code. It's where developers store, share, and collaborate on software projects. Owned by Microsoft.
...
Go to github.com/explore and browse trending repos. AI models, games, OS code — all free to read.

## Go Deeper

- Search for "GitHub explained simply" — you'll find great visual guides
- 🔗 [Read the full SpeakNerd term page](https://speaknerd.ai/terms/github)
...
*Next week: **Repository** — we'll break down what it means and why you should care.*
